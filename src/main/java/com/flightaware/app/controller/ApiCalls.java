...
public class ApiCalls {
	...
	{
		date = date.replace("-", "");
		String url = "https://timetable-lookup.p.rapidapi.com/TimeTable/"+src.toUpperCase()+"/"+dest.toUpperCase()+"/"+date+"/?Connection=NONSTOP";
		System.out.println(url);
		HttpRequest request = HttpRequest.newBuilder()
				.uri(URI.create(url))
				.header("x-rapidapi-key", "8eaa81137bmsha0173e1f73f8c52p194944jsnda4d5442a9b4")
	...
	public String getAirportInfo(String code) throws IOException, InterruptedException, ParseException
	{
		String url = "https://timetable-lookup.p.rapidapi.com/airports/"+code.toUpperCase();
		System.out.println(url);
		HttpRequest request = HttpRequest.newBuilder()
				.uri(URI.create(url))
				.header("x-rapidapi-key", "8eaa81137bmsha0173e1f73f8c52p194944jsnda4d5442a9b4")
		...
		//return "<Airports><Airport IATACode=\"LAX\" State=\"CA\" Country=\"US\" Name=\"Los Angeles International Airport\" Latitude=\"33.942\" Longitude=\"-118.407\"/></Airports>";
		
	}
	
	public String getAirportAirlines(String code) throws IOException, InterruptedException, ParseException
	{
		String url = "https://timetable-lookup.p.rapidapi.com/airports/"+code.toUpperCase()+"/airlines";
		System.out.println(url);
		HttpRequest request = HttpRequest.newBuilder()
				.uri(URI.create(url))
				.header("x-rapidapi-key", "8eaa81137bmsha0173e1f73f8c52p194944jsnda4d5442a9b4")
		...
		//return "<Airports><Carrier IATACode=\"LAX\" Code=\"3U\" Name=\"Sichuan Airlines\"/><Carrier IATACode=\"LAX\" Code=\"9X\" Name=\"Southern Airways Express\"/><Carrier IATACode=\"LAX\" Code=\"AA\" Name=\"American Airlines\"/><Carrier IATACode=\"LAX\" Code=\"AC\" Name=\"Air Canada\"/><Carrier IATACode=\"LAX\" Code=\"AF\" Name=\"Air France\"/></Airports>";
